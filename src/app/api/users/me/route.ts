...
export async function PUT(req: NextRequest) {
  try {
    ...
    let imageStatus = {
      ...
      wasOldAvatarDeleted: false,
      uploadedImage: null as any, // Will hold Cloudinary response
    ...
    if (file) {
      ...
      if (user.avatar && !user.avatar.includes("default/profile.jpg")) {
        imageStatus = {
          ...
          wasOldAvatarDeleted: false,
          uploadedImage, // Full Cloudinary response
          oldAvatar: user.avatar,
          newAvatar: uploadedImage.secure_url
        };
